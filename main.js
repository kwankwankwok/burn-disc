const translations = {
  tc: {
    ...
    title: "燒碟服務香港",
    intro:
      "提供香港本地燒碟服務，服務範圍覆蓋全香港，可將你的檔案燒錄成光碟。無論是將車cam片燒碟作交通投訴、影住駕提交或交通意外證據，還是法律文件、法庭證據呈堂、交功課、做project、資料備份或提交文件用途，最快即日起貨。收費 $20/1、$50/3，如需燒碟請 WhatsApp 56294422 查詢。",
  ...
  sc: {
    ...
    title: "烧碟服务香港",
    intro:
      "提供香港本地烧碟服务，服务范围覆盖全香港，可将你的档案烧录成光碟。无论是将车cam片烧碟作交通投诉、影住驾提交或交通意外证据，还是法律文件、法庭证据呈堂、交功课、做project、资料备份或提交文件用途，最快即日起货。收费 $20/1、$50/3，如需烧碟请 WhatsApp 56294422 查询。",
